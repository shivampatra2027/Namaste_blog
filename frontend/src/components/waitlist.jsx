...
import { ArrowRight, Sparkles, Code, Star, ExternalLink, BookOpen } from "lucide-react";
    ...
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden xl:h-screen">
      ...
      <div className="relative z-[100] mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <motion.h1
          ...
          className={cn(
            "mb-4 cursor-crosshair text-4xl font-bold sm:text-7xl font-sans bg-gradient-to-b from-gray-900 via-gray-700 to-gray-500 dark:from-white dark:via-gray-200 dark:to-gray-400 bg-clip-text text-transparent",
          )}>
          Join the{" "}
